      ...
      <div class="zyro-container d-flex justify-content-center align-items-center" style="min-height: 60vh;">
        ...
        <div class="card border-0 shadow-sm rounded-4 dark:bg-[#1a2533] p-4 p-md-5 text-center animation-fade-up" style="max-width: 600px; width: 100%;">
          ...
          <p class="text-muted dark:text-gray-400 mb-4 px-md-3">
            Cảm ơn bạn đã tin tưởng và mua sắm tại <strong class="text-urban">ZYRO</strong>. Đơn hàng của bạn đã được ghi nhận và sẽ sớm được giao đến bạn.
          </p>
          ...
          <div class="bg-light dark:bg-[#212529] p-4 rounded-4 border dark:border-gray-700 mb-4 text-start shadow-sm mx-auto w-100">
            <div class="d-flex justify-content-between mb-2 align-items-center">
              ...
              <span class="fw-bold text-urban font-monospace fs-5">#{{ orderCode }}</span>
            </div>
            <div class="d-flex justify-content-between mb-2">
              <span class="text-muted small fw-semibold">Trạng thái:</span>
              <span class="fw-semibold text-warning"><i class="bi bi-hourglass-split me-1"></i> Đang chờ xử lý</span>
            </div>
            <div class="mt-3 pt-3 border-top dark:border-gray-600 text-center">
              <small class="text-muted dark:text-gray-400 fst-italic"><i class="bi bi-envelope-check me-1"></i> Chi tiết biên lai đã được gửi vào Email của bạn.</small>
            </div>
          </div>

          <div class="d-flex flex-column flex-sm-row gap-3 justify-content-center mt-2">
            <router-link to="/user/orders" class="btn btn-outline-secondary dark:text-gray-300 dark:border-gray-600 dark:bg-[#2b3035] rounded-pill px-4 py-2.5 fw-bold transition-all hover-urban-outline flex-grow-1">
              <i class="bi bi-receipt me-1"></i> Xem Đơn Hàng
            </router-link>
            <router-link to="/" class="btn btn-urban text-white rounded-pill px-4 py-2.5 fw-bold shadow-sm transition-all hover-transform flex-grow-1">
...
const orderCode = ref(route.query.order || 'ZYRO-PENDING');
...
.btn-urban { background-color: var(--color-c-hover, #547792); border: none; transition: 0.2s ease; }
.btn-urban:hover { background-color: var(--color-c-dark, #213448); color: white; }

.hover-urban-outline:hover { background-color: var(--color-c-hover, #547792) !important; color: white !important; border-color: var(--color-c-hover, #547792) !important; }
