...
const fetchProvinces = async () => {
  ...
  try {
    ...
    console.error("❌ Lỗi API Tỉnh thành:", err.message);
...
const onProvinceChange = async () => {
  ...
  try {
    ...
    if (p) {
      ...
      if (res.data && res.data.districts && Array.isArray(res.data.districts)) {
        districts.value = res.data.districts;
      }
    }
  } catch (err) {
    console.error("❌ Lỗi API Quận huyện:", err.message);
  } finally {
...
const onDistrictChange = async () => {
  ...
  try {
    ...
    if (d) {
      ...
      if (res.data && res.data.wards && Array.isArray(res.data.wards)) {
        wards.value = res.data.wards;
      }
    }
  } catch (err) {
    console.error("❌ Lỗi API Phường xã:", err.message);
  } finally {
