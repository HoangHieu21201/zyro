<!-- frontend/src/components/client/QuickViewModal.vue -->
<template>
  <Teleport to="body">
    <div class="quick-view-wrapper">
            ...
            <div class="row g-4 g-lg-5">
              ...
              <div class="col-md-5">
                <div class="main-img-box border border-light-subtle dark:border-gray-700 rounded-3 mb-3 bg-light dark:bg-[#121416] d-flex justify-content-center align-items-center overflow-hidden">
                  <img :src="activeImage || defaultImage" @error="handleImageError" class="w-100 h-100 object-fit-cover transition-all" style="aspect-ratio: 3/4;">
                </div>
              ...
              <!-- THÔNG TIN CHI TIẾT & CHỌN MUA BÊN PHẢI -->
              <div class="col-md-7 d-flex flex-column">
                ...
                <div class="mb-4">
                  <label class="fw-bold mb-2 d-block small text-dark dark:text-gray-200">
                    Màu sắc: 
                    <span class="fw-normal ms-1" :class="selectedColor ? 'text-urban fw-bold' : 'text-danger fst-italic'">
                ...
                <div class="mb-4">
                  <div class="d-flex justify-content-between align-items-end mb-2">
                    <label class="fw-bold small text-dark dark:text-gray-200 m-0">
                      Kích cỡ: 
                      <span class="fw-normal ms-1" :class="selectedSize ? 'text-urban fw-bold' : 'text-danger fst-italic'">
                ...
                <!-- FORM ĐẶT HÀNG -->
                <div class="d-flex flex-wrap gap-3 align-items-stretch mt-auto pt-2 border-top border-light-subtle dark:border-gray-700 pt-3">
      ...
      <!-- BỔ SUNG: NHÚNG COMPONENT SIZE GUIDE MODAL VÀO ĐÂY -->
      <SizeGuideModal 
        :show="showSizeGuide" 
        :product="product" 
...
// State điều khiển việc hiển thị SizeGuideModal
...
watch(() => props.isOpen, (val) => {
  if (val && props.product) {
    ...
    // Đóng luôn Size Guide nếu lỡ tắt Quick View mà chưa tắt Size Guide
...
/* FIX: Đã giảm z-index của nền và modal xem nhanh xuống để SizeGuideModal nổi lên trên */
.qv-backdrop {
  position: fixed;
...
html.dark .disabled-size { background-color: #2b3035; border-color: #373b3e !important; }
...
/* DARK MODE CHUẨN BOOTSTRAP */
[data-bs-theme="dark"] .bg-white { background-color: #1e2125 !important; }
[data-bs-theme="dark"] .border-light-subtle { border-color: #373b3e !important; }
[data-bs-theme="dark"] .text-dark { color: #f8f9fa !important; }
[data-bs-theme="dark"] .bg-light { background-color: #121416 !important; }
[data-bs-theme="dark"] .form-control { background-color: #1e2125 !important; border-color: #373b3e !important; color: #fff; }
[data-bs-theme="dark"] .input-group-text { background-color: #2b3035 !important; border-color: #373b3e !important; color: #adb5bd; }
</style>