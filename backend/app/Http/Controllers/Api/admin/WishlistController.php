...
{
    /**
     * Dashboard Thống kê Sản phẩm được yêu thích
     */
    public function index(Request $request): JsonResponse
    {
        try {
            ...
            // Phân trang và Load data sản phẩm
