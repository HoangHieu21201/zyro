...
class BannerController extends Controller
{
    ...
    {
        Cache::forget('banners_list_all');
        Cache::forget('banners_list_main_slider');
        Cache::forget('banners_list_home_banner_1');
        Cache::forget('banners_list_home_banner_2');
        Cache::forget('banners_list_popup');
    }
    ...
    public function index(Request $request): JsonResponse
    {
        try {
            ...
            $cacheKey = 'banners_list_' . $position;

            $banners = Cache::remember($cacheKey, 86400, function () use ($position) {
