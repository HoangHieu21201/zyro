...
// File: backend/app/Http/Requests/Tier/UpdateMembershipTierRequest.php
...
class UpdateMembershipTierRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            // ĐÃ THÊM min:3
            'name'                 => ['required', 'string', 'min:3', 'max:100', Rule::unique('membership_tiers', 'name')->ignore($tierId)->whereNull('deleted_at')],
